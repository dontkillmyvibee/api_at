...
from tests.users.get.get_user.allure_helpers import TestGetUserPositiveHelper, TestGetUserNegativeHelper


class TestGetUser(TestGetUserPositiveHelper):
    @allure.title("Successful get user")
...
class TestGetUserNegative(TestGetUserNegativeHelper):
    @allure.title("Get user with invalid user id")
